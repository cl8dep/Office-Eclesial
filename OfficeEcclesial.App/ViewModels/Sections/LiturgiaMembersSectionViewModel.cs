...
{
    public class LiturgiaMembersSectionViewModel : BindableBase
    {
        #region Fields
        private ObservableCollection<LiturgiaMembers> _elementsCollection;
        ...
        #region Properties
        public ObservableCollection<LiturgiaMembers> ElementsCollection
        {
        ...
        #region Properties
        private LiturgiaMembersService Service { get; }
        private PdfService PdfService { get; }
        #endregion

        #region Constructor
        public LiturgiaMembersSectionViewModel(LiturgiaMembersService service, PdfService pdfService)
        {
            Service = service;
        ...
        public DelegateCommand<LiturgiaMembers> SelectedItemCommand => new DelegateCommand<LiturgiaMembers>(OnSelectedItemCommand);
        ...
        public DelegateCommand<LiturgiaMembers> EditElementCommand => new DelegateCommand<LiturgiaMembers>(OnEditElementCommand);
        public DelegateCommand<LiturgiaMembers> RemoveElementCommand => new DelegateCommand<LiturgiaMembers>(OnRemoveElementCommand);
        #endregion
        ...
        private void OnAddNewCommand()
        {
            ...
            {
                Service.Add(person.ToLiturgiaMembers());
                InitializeComponent();
            });
        }
        private void OnEditElementCommand(LiturgiaMembers item)
        {
            var person = Application.GetService<AddPersonDialog>().ShowDialog(item);
            if (person == null) return;
            Dispatcher.InvokeAsync(() =>
            {
                Service.Edit(person.ToLiturgiaMembers());

                InitializeComponent();
            });
        }
        private void OnRemoveElementCommand(LiturgiaMembers item)
        {
            Dispatcher.InvokeAsync(() =>
            {
        ...
        private void OnSelectedItemCommand(LiturgiaMembers item)
        {
        ...
        private void OnGeneratePdfCommand()
        {
            ...
            pdfWorker.DoWork += (sender, args) =>
            {
                ...
                PdfService.GenerateLiturgiaMembersList(ElementsCollection, saveFileDialog1.FileName);
        ...
        public override void InitializeComponent()
        {
            ...
            ElementsCollection = new ObservableCollection<LiturgiaMembers>();
