...
{
    public class LiturgiaCantoresSectionViewModel : BindableBase
    {
        #region Fields
        private ObservableCollection<LiturgiaCantores> _elementsCollection;
        ...
        #region Properties
        public ObservableCollection<LiturgiaCantores> ElementsCollection
        {
        ...
        #endregion
        public LiturgiaCantoresService Service { get; }
        public PdfService PdfService { get; }

        #region Constructor
        public LiturgiaCantoresSectionViewModel(LiturgiaCantoresService service, PdfService pdfService)
        {
            Service = service;
        ...
        public DelegateCommand<LiturgiaCantores> SelectedItemCommand => new DelegateCommand<LiturgiaCantores>(OnSelectedItemCommand);
        ...
        public DelegateCommand<LiturgiaCantores> EditElementCommand => new DelegateCommand<LiturgiaCantores>(OnEditElementCommand);
        public DelegateCommand<LiturgiaCantores> RemoveElementCommand => new DelegateCommand<LiturgiaCantores>(OnRemoveElementCommand);
        #endregion
        ...
        private void OnAddNewCommand()
        {
            ...
            {
                Service.Add(person.ToLiturgiaCantores());
                InitializeComponent();
            });
        }
        private void OnEditElementCommand(LiturgiaCantores item)
        {
            var person = Application.GetService<AddPersonDialog>().ShowDialog(item);
            if (person == null) return;
            Dispatcher.InvokeAsync(() =>
            {
                Service.Edit(person.ToLiturgiaCantores());

                InitializeComponent();
            });
        }
        private void OnRemoveElementCommand(LiturgiaCantores item)
        {
            Dispatcher.InvokeAsync(() =>
            {
        ...
        private void OnSelectedItemCommand(LiturgiaCantores item)
        {
        ...
        private void OnGeneratePdfCommand()
        {
            ...
            pdfWorker.DoWork += (sender, args) =>
            {
                ...
                PdfService.GenerateLiturgiaCantoresList(ElementsCollection, saveFileDialog1.FileName);
        ...
        public override void InitializeComponent()
        {
            ...
            ElementsCollection = new ObservableCollection<LiturgiaCantores>();
