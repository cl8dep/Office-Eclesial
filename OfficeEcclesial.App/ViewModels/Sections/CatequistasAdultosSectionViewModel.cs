...
{
    public class CatequistasAdultosSectionViewModel : BindableBase
    {
        #region Fields
        private ObservableCollection<CatequistaAdultos> _elementsCollection;
        ...
        #region Properties
        public ObservableCollection<CatequistaAdultos> ElementsCollection
        {
        ...
        #region Properties
        private CatequistasAdultosService Service { get; }
        private PdfService PdfService { get; }
        #endregion

        #region Constructor
        public CatequistasAdultosSectionViewModel(CatequistasAdultosService service, PdfService pdfService)
        {
            Service = service;
        ...
        public DelegateCommand<CatequistaAdultos> SelectedItemCommand => new DelegateCommand<CatequistaAdultos>(OnSelectedItemCommand);
        ...
        public DelegateCommand<CatequistaAdultos> EditElementCommand => new DelegateCommand<CatequistaAdultos>(OnEditElementCommand);
        public DelegateCommand<CatequistaAdultos> RemoveElementCommand => new DelegateCommand<CatequistaAdultos>(OnRemoveElementCommand);
        #endregion
        ...
        private void OnAddNewCommand()
        {
            ...
            {
                Service.Add(person.ToCatequistaAdultos());
                InitializeComponent();
            });
        }
        private void OnEditElementCommand(CatequistaAdultos item)
        {
            var person = Application.GetService<AddPersonDialog>().ShowDialog(item);
            if (person == null) return;
            Dispatcher.InvokeAsync(() =>
            {
                Service.Edit(person.ToCatequistaAdultos());

                InitializeComponent();
            });
        }
        private void OnRemoveElementCommand(CatequistaAdultos item)
        {
            Dispatcher.InvokeAsync(() =>
            {
        ...
        private void OnSelectedItemCommand(CatequistaAdultos item)
        {
        ...
        private void OnGeneratePdfCommand()
        {
            ...
            pdfWorker.DoWork += (sender, args) =>
            {
                ...
                PdfService.GenerateCatequistasAdultosList(ElementsCollection, saveFileDialog1.FileName);
        ...
        public override void InitializeComponent()
        {
            ...
            ElementsCollection = new ObservableCollection<CatequistaAdultos>();
