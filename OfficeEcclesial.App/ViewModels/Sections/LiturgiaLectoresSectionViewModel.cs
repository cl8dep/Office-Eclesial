...
{
    public class LiturgiaLectoresSectionViewModel : BindableBase
    {
        #region Fields
        private ObservableCollection<LiturgiaLectores> _elementsCollection;
        ...
        #region Properties
        public ObservableCollection<LiturgiaLectores> ElementsCollection
        {
        ...
        #region Properties
        private LiturgiaLectoresService Service { get; }
        private PdfService PdfService { get; }
        #endregion

        #region Constructor
        public LiturgiaLectoresSectionViewModel(LiturgiaLectoresService service, PdfService pdfService)
        {
            Service = service;
        ...
        public DelegateCommand<LiturgiaLectores> SelectedItemCommand => new DelegateCommand<LiturgiaLectores>(OnSelectedItemCommand);
        ...
        public DelegateCommand<LiturgiaLectores> EditElementCommand => new DelegateCommand<LiturgiaLectores>(OnEditElementCommand);
        public DelegateCommand<LiturgiaLectores> RemoveElementCommand => new DelegateCommand<LiturgiaLectores>(OnRemoveElementCommand);
        #endregion
        ...
        private void OnAddNewCommand()
        {
            ...
            {
                Service.Add(person.ToLiturgiaLectores());
                InitializeComponent();
            });
        }
        private void OnEditElementCommand(LiturgiaLectores item)
        {
            var person = Application.GetService<AddPersonDialog>().ShowDialog(item);
            if (person == null) return;
            Dispatcher.InvokeAsync(() =>
            {
                Service.Edit(person.ToLiturgiaLectores());

                InitializeComponent();
            });
        }
        private void OnRemoveElementCommand(LiturgiaLectores item)
        {
            Dispatcher.InvokeAsync(() =>
            {
        ...
        private void OnSelectedItemCommand(LiturgiaLectores item)
        {
        ...
        private void OnGeneratePdfCommand()
        {
            ...
            pdfWorker.DoWork += (sender, args) =>
            {
                ...
                PdfService.GenerateLiturgiaLectoresList(ElementsCollection, saveFileDialog1.FileName);
        ...
        public override void InitializeComponent()
        {
            ...
            ElementsCollection = new ObservableCollection<LiturgiaLectores>();
