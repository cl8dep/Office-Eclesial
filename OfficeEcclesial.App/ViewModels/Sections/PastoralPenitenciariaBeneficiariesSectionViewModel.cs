...
{
    public class PastoralPenitenciariaBeneficiariesSectionViewModel : BindableBase
    {
        #region Fields
        private ObservableCollection<PastoralPenitenciariaBeneficiaries> _elementsCollection;
        ...
        public ObservableCollection<PastoralPenitenciariaBeneficiaries> ElementsCollection
        {
        ...
        #region Properties
        public PastoralPenitenciariaBeneficiariesService Service { get; }
        public PdfService PdfService { get; }
        #endregion

        #region Constructor
        public PastoralPenitenciariaBeneficiariesSectionViewModel(PastoralPenitenciariaBeneficiariesService service, PdfService pdfService)
        {
            Service = service;
        ...
        private void OnAddNewCommand()
        {
            ...
            {
                Service.AddMember(person.ToPastoralPenitenciariaBeneficiaries());
                InitializeComponent();
            });*/
        }
        private void OnEditElementCommand(PastoralPenitenciariaMembers item)
        {
            ...
            Dispatcher.InvokeAsync(() =>
            {
                Service.EditMember(person.ToPastoralPenitenciariaBeneficiaries());
        ...
        private void OnGeneratePdfCommand()
        {
            ...
            pdfWorker.DoWork += (sender, args) =>
            {
                ...
                PdfService.GeneratePastoralPenitenciariaBeneficiariesList(ElementsCollection, saveFileDialog1.FileName);
        ...
        public override void InitializeComponent()
        {
            ...
            ElementsCollection = new ObservableCollection<PastoralPenitenciariaBeneficiaries>();
